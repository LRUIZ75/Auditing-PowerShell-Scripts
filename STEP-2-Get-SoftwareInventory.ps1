...
foreach($Computer in $RemoteComputer) {
    ...
    Write-Progress -Activity 'Fetching software inventory' -Status ('Working on host {0} [{1}/{2}]' -f $computer, $count, $RemoteComputer.Count) -PercentComplete (($count/$RemoteComputer.Count)*100)
